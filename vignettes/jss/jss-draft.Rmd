...
- [ ] Define the model.  This is basically given by (24).  Please see \pkg{flexEL} vignette for details on the model.

- [ ] Write down the moment conditions.  We need to know what $\gg(\xx, y; \bbe)$ is in order to implement the EL model.  In this case it is

	$$
	\gg(\xx, y; \bbe) = (y - \xx'\bbe) \xx.
	$$

- [ ] Also need to write down the gradient, i.e., $\frac{\ud}{\ud \bbe} \gg(\xx, y; \bbe)$.
