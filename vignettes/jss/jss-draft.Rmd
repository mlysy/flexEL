...
Let $y_1,\cdots,y_n$ where $y_i\in\R^{d+1}$ be iid observations from an unknown distribution $F_0(\yy)$, about which a parameter of interest $\tth$ is defined as satisfying an $m$-dimensional moment condition:
...
[TODO: provide the weighted EL here which can be used in the right-censored case with EM instead?]
