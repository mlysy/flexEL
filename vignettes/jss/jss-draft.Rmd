...
gel <- flexEL::GenEL$new(n_obs, n_eqs) # initalize an GenEL object
...
optim(c(0.5,2.5), fn = mr2_neglogel, gr = mr2_neglogel_grad,
      y, X, gel, method = "BFGS")
```
