...
The problem in (\ref{eq:noncensopt}) is a constrained convex optimization problem, and its optimal solution can be found by solving its dual problem derived through the Lagrangian function, as described by @owen1990.

Specifically, provided that $\bm 0$ is in the convex full of the points $\gg(\yy_1;\tth),\cdots,\gg(\yy_n;\tth)$, a unique optimal weight vector exist and can be shown to be
\begin{equation}
