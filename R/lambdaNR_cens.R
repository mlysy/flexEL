...
#'
#' @template args-G
#' @param weights Length-`n_obs` vector of weights for weighted Newton-Raphson algorithm.
#' @template args-max_iter
#' @template args-rel_tol
#' @template args-verbose
#' @return Length-`n_eqs` vector corresponding to the solution of the optimization problem.
