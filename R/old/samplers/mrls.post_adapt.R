#' Adaptive posterior sampler for mean regression (location-scale model)
#' 
...
#' @param sig2Init A scalar of initial value for the squared scale parameter.
...
#' @details ...
#' @export mrls.post_adapt
mrls.post_adapt <- function(y, X, Z, nsamples, nburn, betaInit, gammaInit, sig2Init, 
  ...
  .MeanRegLS_post_adapt(y, t(X), t(Z), nsamples, nburn, 
