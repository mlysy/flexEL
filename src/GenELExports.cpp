...
///
// [[Rcpp::export]]
void GenEL_set_supp_adj(SEXP p_gel, 
                        bool supp_adj, 
...
///
// [[Rcpp::export]]
Eigen::VectorXd GenEL_lambda_nr(SEXP p_gel, 
                                Eigen::MatrixXd G, 
...
///
// [[Rcpp::export]]
Eigen::VectorXd GenEL_omega_hat(SEXP p_gel, 
...
///
// [[Rcpp::export]]
double GenEL_weighted_logel(SEXP p_gel, 
                            Eigen::MatrixXd G, 
                            Eigen::VectorXd weights, 
                            bool check_conv) {
  Rcpp::XPtr<flexEL::GenEL<double> > gel(p_gel);
...
///
// [[Rcpp::export]]
Rcpp::List GenEL_weighted_logel_grad(SEXP p_gel, 
                                     Eigen::MatrixXd G, 
                                     Eigen::VectorXd weights,
                                     bool check_conv) {
  Rcpp::XPtr<flexEL::GenEL<double> > gel(p_gel);
